...
-- ============================================================
-- TABLE 10: redo_requests
-- Tracks user requests to retake the assessment (max 3 requests total)
-- ============================================================
...
CREATE INDEX idx_rr_user_status ON redo_requests(user_id, status);

-- ============================================================
-- TABLE 11: notifications
-- Unified notifications for both users and admins
-- ============================================================
...
CREATE INDEX idx_notif_recipient ON notifications(recipient_type, recipient_id, is_read, created_at);

-- Grant CREATE TABLE to app user for future migrations
GRANT CREATE ON career_assessment_db.* TO 'carrera_app'@'localhost';
FLUSH PRIVILEGES;
